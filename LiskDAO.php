...
abstract class LiskDAO {
  ...
  const CONFIG_AUX_ID               = 'auxiliary-id';
...
/* -(  Hooks and Callbacks  )------------------------------------------------ */
  ...
  /**
   * Generate a new ID, used by CONFIG_AUX_ID.
   *
   * @return id    Unique, newly allocated ID.
   *
   * @task   hook
   */
  protected function generateID() {
    throw new Exception(
      "To use CONFIG_AUX_ID, you need to overload ".
      "generateID() to perform ID generation.");
  }
  ...
  protected function willSaveObject() {
    ...
    if ($this->getConfigOption(self::CONFIG_AUX_ID) && !$this->getID()) {
